...
- Commands: `npm ci`, `npm run start:read-only -w @stryke/reference-bot`, then
  `npm run start:live -w @stryke/reference-bot` without live environment gates
...
scripts were corrected to build `@stryke/sdk` explicitly before this successful
