...
export const configControlInventory = {
  ...
  STRYKE_STATE_BACKEND: { consumer: "file or Postgres runtime state composition", evidence: configEvidence("wires_postgres_state_controls_and_redacts_the_database_url") },
  STRYKE_DATABASE_URL: { consumer: "PostgresReferenceBotState connection pool", evidence: configEvidence("wires_postgres_state_controls_and_redacts_the_database_url") },
  STRYKE_STATE_NAMESPACE: { consumer: "Postgres checkpoint, round, and lease isolation", evidence: configEvidence("wires_postgres_state_controls_and_redacts_the_database_url") },
  STRYKE_LEASE_TTL_MS: { consumer: "Postgres renewable singleton lease duration", evidence: configEvidence("wires_postgres_state_controls_and_redacts_the_database_url") },
