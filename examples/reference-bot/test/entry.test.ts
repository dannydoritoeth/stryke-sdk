...
const input = () => ({ fairProbability: 0.7, quote: quote(), config: live, secondsRemaining: 120, tradeSizeLamports: live.tradeSizeLamports, aggregateExposureLamports: 0n, openPositions: 0, dataFresh: true });
...
describe("entry decisions", () => {
  ...
  it("edge_impact_time_size_position_and_aggregate_caps_each_block_entry", () => {
    const cases = [
      ...
      { expected: "size", change: { tradeSizeLamports: live.maximumTradeSizeLamports + 1n } },
